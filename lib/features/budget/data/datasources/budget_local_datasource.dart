...
class BudgetLocalDataSourceImpl implements BudgetLocalDataSource {
  ...
  Future<List<BudgetModel>> getAllBudgets() async {
    try {
      final budgetDb = await hive.openBox<BudgetModel>(DBConstants.budgetDbName);
  ...
  Future<void> deleteBudget(String budgetId) async {
    try {
      ...
      throw DatabaseFailure(message: "Failed to delete budget: ${e.toString()}");
    }
  }
  ...
  Future<List<BudgetModel>> getBudgetsByCategory(String categoryId) async {
    try {
      ...
      throw DatabaseFailure(message: "Failed to get budgets by category: ${e.toString()}");
    }
  }
  ...
  Future<List<BudgetModel>> getActiveBudgets() async {
    try {
      ...
      throw DatabaseFailure(message: "Failed to get active budgets: ${e.toString()}");
    }
  }
}
