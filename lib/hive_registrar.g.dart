...
extension HiveRegistrar on HiveInterface {
  void registerAdapters() {
    ...
    registerAdapter(EnhancedSplitTypeModelAdapter());
    registerAdapter(ExpenseParticipantModelAdapter());
    registerAdapter(GroupActivityModelAdapter());
    registerAdapter(GroupActivityTypeModelAdapter());
    ...
    registerAdapter(SettlementStatusModelAdapter());
    registerAdapter(SharedExpenseModelAdapter());
