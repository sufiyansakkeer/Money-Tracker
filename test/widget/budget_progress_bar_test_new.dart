...
void main() {
  group('BudgetProgressBar Widget Tests', () {
    testWidgets('renders correctly with low percentage', (WidgetTester tester) async {
    ...
    testWidgets('renders correctly with medium percentage', (WidgetTester tester) async {
      // Create a test category
      final category = CategoryEntity(
        id: '1',
        categoryName: 'Food',
    ...
    testWidgets('renders correctly with high percentage', (WidgetTester tester) async {
      // Create a test category
      final category = CategoryEntity(
        id: '1',
        categoryName: 'Food',
    ...
    testWidgets('displays correct spent and remaining amounts', (WidgetTester tester) async {
      // Create a test category
      final category = CategoryEntity(
        id: '1',
        categoryName: 'Food',
      ...
      expect(find.textContaining('Budget: ₹1,000.00 · MONTHLY'), findsOneWidget);
    });
  });
}
