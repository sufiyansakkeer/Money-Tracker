...
// // Custom matcher for TransactionModel
// class IsTransactionModel
//     extends TypeMatcher<transaction_model.TransactionModel> {
//   const IsTransactionModel() : super();
// }

// const isTransactionModel = IsTransactionModel();
...
//     when(mockTransactionBox.add(any)).thenAnswer((_) async => 0);
...
//     verify(mockTransactionBox.add(any)).called(1);
//   });
// }
